...
├── ACTIVATE_ME.py
│
├── tkgen.py (in progress)
├── tkgenimg.py (coming soon)
├── tkgendata.py (coming soon)
├── tktrain.py
│
├── training_data/
├── checkpoints/
...
```bash
git clone https://github.com/CyberPlugger/TinyVideo.git
cd TinyVideo
```
...
```powershell
python mp4_to_dataset.py "C:\bla\bla\bla"
```
